...
Requires CUDA-Z to test if driver installed has CUDA 64-Bit working </br>
for example: Titan 6GB requires driver 388.71 maximum, Newer drivers install, but does Not have CUDA 64-Bit. </br>
